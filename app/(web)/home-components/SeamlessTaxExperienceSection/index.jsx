        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="relative w-full max-w-[460px]">
              ...
              <div className="absolute -top-4 -left-4 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md px-4 py-2.5 rounded-lg shadow-xl border border-emerald-100 dark:border-zinc-800 flex items-center gap-3 z-10">
                <div className="w-9 h-9 rounded-lg bg-emerald-100 dark:bg-emerald-950 text-brand-primary dark:text-emerald-400 flex items-center justify-center font-bold text-sm shrink-0">
                  <CheckCircleFilled />
                </div>
                <div>
              ...
              <div className="absolute -bottom-5 -right-4 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md px-4 py-2.5 rounded-lg shadow-xl border border-emerald-100 dark:border-zinc-800 flex items-center gap-3 z-10">
                <div className="w-9 h-9 rounded-lg bg-amber-100 dark:bg-amber-950 text-amber-600 dark:text-amber-400 flex items-center justify-center font-bold text-sm shrink-0">
                  <DollarOutlined />
                </div>
                <div>

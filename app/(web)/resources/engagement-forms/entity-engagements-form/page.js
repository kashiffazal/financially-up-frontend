  ...
  return (
    <div className="bg-slate-50 dark:bg-zinc-950 min-h-screen transition-colors duration-300">
      <FormPageHeader
        ...
        subtitle="Complete your Company, Trust, Partnership, or SMSF tax engagement onboarding."
      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center text-slate-600 dark:text-zinc-400">
        <div className="p-12 rounded-3xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 shadow-sm">
          <h2 className="text-xl font-bold text-slate-900 dark:text-zinc-100 mb-2">
            Entity Engagement Form Coming Soon
          </h2>
          <p className="text-sm">
            We are currently preparing the entity engagement onboarding form.
          </p>
        </div>
      </main>

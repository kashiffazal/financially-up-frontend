...
import { GlobalOutlined, TeamOutlined, UploadOutlined } from "@ant-design/icons";
          ...
          <div className="pt-4 border-t border-slate-200/60 dark:border-zinc-800 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <AntInput
                type="datepicker"
                name="visaExpiry"
                label={<span className="font-bold text-slate-800 dark:text-zinc-200">Visa Expiry Date</span>}
              ...
              <AntFileUpload
                name="visaEvidence"
                label={<span className="font-bold text-slate-800 dark:text-zinc-200">Upload Visa Grant Letter / Evidence</span>}
        ...
        {residencyChanged && (
          <div className="pt-4 border-t border-slate-200/60 dark:border-zinc-800 space-y-4">
            <Alert
              ...
              className="rounded-xl border-amber-200 bg-amber-50 dark:bg-amber-950/40 text-slate-800 dark:text-zinc-200 mb-3"
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <AntInput
                ...
                label={<span className="font-bold text-slate-800 dark:text-zinc-200">Date Became Australian Resident</span>}
                placeholder="DD/MM/YYYY"
                format="DD/MM/YYYY"
                size="large"
                className="w-full rounded-xl"
              ...
              <AntInput
                ...
                label={<span className="font-bold text-slate-800 dark:text-zinc-200">Date Ceased Australian Residency</span>}
                placeholder="DD/MM/YYYY"
                format="DD/MM/YYYY"
                size="large"
                className="w-full rounded-xl"
            ...
            <AntInput
              name="foreignCountry"
              label={<span className="font-bold text-slate-800 dark:text-zinc-200">Foreign Country of Residence</span>}
            ...
            <AntInput
              type="textarea"
              name="foreignInfo"
              label={<span className="font-bold text-slate-800 dark:text-zinc-200">Describe Overseas Income & Foreign Assets</span>}

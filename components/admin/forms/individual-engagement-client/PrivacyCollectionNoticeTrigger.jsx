...
export const PRIVACY_COLLECTION_CATEGORIES = {
  tfn: {
    ...
    summary:
      "Your TFN is collected under the Taxation Administration Act 1953 and Tax Agent Services Act 2009 for the sole purpose of verifying your identity with the Australian Taxation Office (ATO), linking your profile on the ATO Online Portal, and preparing/lodging your tax returns.",
    details: [
  ...
  bank: {
    ...
    summary:
      "Your Australian bank account BSB and account number are collected to enable direct deposit of your ATO income tax refunds and authorized fee processing.",
    details: [
  ...
  id: {
    ...
    summary:
      "Primary and supporting government identity documents (Passport, Driver's License, Medicare Card) are collected under Tax Agent Services Act 2009 (TASA 2009) identity verification guidelines and Anti-Money Laundering laws.",
    details: [
  ...
  visa: {
    ...
    summary:
      "Visa subclass numbers, expiry dates, and first arrival dates are collected to evaluate your Australian tax residency status under the Income Tax Assessment Act 1936.",
    details: [
  ...
  biometric: {
    ...
    summary:
      "If you choose Electronic Verification, live selfie photographs and facial matching templates are collected under the Privacy Act 1988 sensitive information rules.",
    details: [
  ...
  aml: {
    ...
    summary:
      "Information regarding foreign income, business structures, entity involvement, and source of funds is collected under the Anti-Money Laundering and Counter-Terrorism Financing Act (AML/CTF Act) and sanctions screening regulations.",
    details: [
...
export const FULL_PRIVACY_COLLECTION_NOTICE_TEXT = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: "We collect personal information primarily to assess and accept your engagement, verify your identity and authority, prepare and lodge tax returns, Activity Statements, and registrations with the ATO/ABR, communicate regarding your tax affairs, and fulfill AML/CTF and professional obligations.",
    },
    {
      title: "3. Consequences of not providing information",
      text: "If you do not provide requested information (such as TFN, ID documents, or income records), we may be unable to verify your identity, access ATO portal pre-fill records, accept your engagement, or electronically lodge your tax return.",
    },
    {
      title: "4. Usual disclosures",
      text: "We disclose information to the Australian Taxation Office (ATO), Australian Business Register (ABR), Tax Practitioners Board (TPB), AUSTRAC (where required by law), approved software providers (e.g. Xero/MYOB/QuickBooks), secure cloud hosting, and approved identity verification providers.",
    },
    {
      title: "5. Overseas access and cloud infrastructure",
      text: "Client information may be stored or processed using secure cloud infrastructure located in Australia and overseas locations operated by approved technology service providers under strict confidentiality and security safeguards.",
    },
    {
      title: "6. Access, correction and complaints",
      text: "Our Privacy Policy contains information about how you can access and correct your personal information or lodge a privacy complaint. View the full Privacy Policy at www.financiallyup.com.au/privacy.",
    },
  ],
};
    ...
    <>
      <span className="inline-flex items-center gap-1.5 ml-2">
        <button
          type="button"
          onClick={handleOpen}
          className="inline-flex items-center gap-1 text-xs font-bold text-brand-primary hover:text-emerald-700 dark:text-emerald-400 underline cursor-pointer bg-emerald-50/80 dark:bg-emerald-950/60 px-2.5 py-0.5 rounded-xl border border-emerald-200/80 dark:border-emerald-800 transition-all hover:scale-105"
        >
          ...
          {!showFull ? (
            <div className="space-y-4 text-xs leading-relaxed">
              <div className="p-4 rounded-xl bg-emerald-50/80 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-800 space-y-1">
                ...
                <p className="text-slate-800 dark:text-zinc-200 m-0 font-medium">
                  {catData.summary}
                </p>
              </div>

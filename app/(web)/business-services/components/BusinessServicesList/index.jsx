...
export default function BusinessServicesList() {
  ...
  return (
    <section
      className={`bg-gradient-to-b from-white via-brand-bg-lighter/40 to-white dark:from-zinc-950 dark:via-zinc-900/30 dark:to-zinc-950 pt-12 md:pt-20 transition-colors duration-300 ${styles.sectionWrapper}`}
    >

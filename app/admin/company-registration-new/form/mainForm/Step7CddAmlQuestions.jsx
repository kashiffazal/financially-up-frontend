    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      <div className="border-b border-slate-100 dark:border-zinc-800 pb-3">
        ...
        <p className="text-sm text-slate-600 dark:text-zinc-400 mt-1">
          Statutory questions required under the Anti-Money Laundering and
      ...
      <div className="p-5 rounded-xl bg-slate-50/70 dark:bg-zinc-900/50 border border-slate-200/80 dark:border-zinc-800 space-y-4">
        ...
        <div className="space-y-4">
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                1. Commercial Rationale: What is the commercial purpose for
                creating this company now? *
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                2. Counterparties: Describe expected customers, suppliers,
                assets, and countries connected. *
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                3. Products & Services: What specific products or services will
                the company provide? *
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                4. Will the company receive or send international cross-border
                payments?
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                5. Will the company deal with cash, high-value goods,
                crypto/virtual assets, remittance, gambling, loans, or
                import/export?
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                6. Will any director, shareholder, or controller be a
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                7. Is any director, shareholder, or controller subject to
                sanctions, adverse media, or bankruptcy restrictions?
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                8. Will the company use third-party funds, loans, gifts, or
                offshore funding?
              </span>
            }
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                9. Has the client been asked or instructed to create this
          ...
          <AntInput
            ...
            label={
              <span className="font-bold text-slate-800 dark:text-zinc-200">
                10. Is the structure intended to conceal ownership, hold assets
                for others, or separate legal from beneficial ownership?
              </span>
            }

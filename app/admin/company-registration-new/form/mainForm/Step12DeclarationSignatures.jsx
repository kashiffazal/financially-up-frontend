      ...
      <div className="p-4 sm:p-5 rounded-xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/50 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-zinc-400 leading-normal">
            I/we confirm that the information in this form is true, complete and
            not misleading.
          </p>
          <AntInput
            type="checkbox"
        ...
        <div className="border-t border-emerald-200/50 dark:border-emerald-900/50 pt-3.5 space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-zinc-400 leading-normal">
            I/we authorise Financially Up to use this information to assess
            AML/CTF risk, complete CDD, verify identity information, conduct
            PEP/sanctions/adverse media screening, and prepare/lodge company
        ...
        <div className="border-t border-emerald-200/50 dark:border-emerald-900/50 pt-3.5 space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-zinc-400 leading-normal">
            I/we confirm that all proposed directors, secretaries and members
            have consented or will sign consents before lodgement.
          </p>
          <AntInput
            type="checkbox"
            name="declaration3"
        ...
        <div className="border-t border-emerald-200/50 dark:border-emerald-900/50 pt-3.5 space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-zinc-400 leading-normal">
            I/we confirm that all beneficial owners/controllers have been
            disclosed, including any person who controls the company through
            indirect ownership, agreements, nominees, funding or practical
            influence.
          </p>
          <AntInput
            type="checkbox"
        ...
        <div className="border-t border-emerald-200/50 dark:border-emerald-900/50 pt-3.5 space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-zinc-400 leading-normal">
            I/we understand Financially Up may request further information,
            decline, suspend or exit the matter, or make reports to AUSTRAC if
            required by law.
          </p>
          <AntInput
            type="checkbox"
        ...
        <div className="border-t border-emerald-200/50 dark:border-emerald-900/50 pt-3.5 space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-zinc-400 leading-normal">
            I/we understand Financially Up cannot provide legal advice unless
            separately agreed and may recommend independent legal advice for
            constitutions, shareholder agreements, nominee arrangements, trusts

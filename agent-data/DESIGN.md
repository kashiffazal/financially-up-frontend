...
Cards use `rounded-xl` or `rounded-xl`. Buttons use `rounded-xl`. Pills / tags use `rounded-full`.
...
- **Primary:** brand green fill, white text, `rounded-xl`, medium weight. Use for main CTAs ("Book an Appointment").
